...
$(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libmpv.a: $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libspirv-cross-c-shared.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libshaderc.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libiconv.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libz.a $(FFMPEG_LIBS) $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libass.a | $(DEPENDENCY_SOURCE_DIRECTORY_MPV) $(DEPENDENCY_OUTPUT_DIRECTORY)
	...
	WINDRES=$(WINDRES) \
	python3.11 $(DEPENDENCY_SOURCE_DIRECTORY_MPV)/waf configure \
	...
	LDFLAGS="-L$(DEPENDENCY_OUTPUT_DIRECTORY)/lib" \
	WINDRES=$(WINDRES) \
	python3.11 $(DEPENDENCY_SOURCE_DIRECTORY_MPV)/waf build --verbose \
	&& \
	CC=$(CC) \
	CXX=$(CXX) \
	AR=$(AR) \
	...
	CFLAGS="-I$(DEPENDENCY_OUTPUT_DIRECTORY)/include -I$(DEPENDENCY_OUTPUT_DIRECTORY)/include/spirv_cross" \
	LDFLAGS="-L$(DEPENDENCY_OUTPUT_DIRECTORY)/lib" \
	python3.11 $(DEPENDENCY_SOURCE_DIRECTORY_MPV)/waf install
