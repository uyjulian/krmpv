...
DEPENDENCY_SOURCE_DIRECTORY_SDL := $(DEPENDENCY_SOURCE_DIRECTORY)/sdl
...
DEPENDENCY_SOURCE_FILE_SDL := $(DEPENDENCY_SOURCE_DIRECTORY)/sdl.tar.gz
...
DEPENDENCY_SOURCE_URL_SDL := https://www.libsdl.org/release/SDL2-2.24.0.tar.gz
...
$(DEPENDENCY_SOURCE_FILE_SDL): | $(DEPENDENCY_SOURCE_DIRECTORY)
	curl --location --output $@ $(DEPENDENCY_SOURCE_URL_SDL)
...
$(DEPENDENCY_SOURCE_DIRECTORY_SDL): $(DEPENDENCY_SOURCE_FILE_SDL)
	mkdir -p $@
...
DEPENDENCY_BUILD_DIRECTORY_SDL := $(DEPENDENCY_BUILD_DIRECTORY)/sdl
...
EXTLIBS += $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libSDL2.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libiconv.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libz.a $(FFMPEG_LIBS) $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libass.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libfribidi.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libharfbuzz.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libfreetype.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libbrotlidec.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libbrotlicommon.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libmpv.a
SOURCES += $(EXTLIBS)
OBJECTS += $(EXTLIBS)
LDLIBS += $(EXTLIBS) $(EXTLIBS) $(EXTLIBS) -luuid -lbcrypt $(OPENGL_LIB) -lgdi32 -lole32 -loleaut32 -ldwmapi -lwinmm -lavrt -lsetupapi -limm32 -lversion
...
$(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libSDL2.a: | $(DEPENDENCY_SOURCE_DIRECTORY_SDL) $(DEPENDENCY_OUTPUT_DIRECTORY)
	mkdir -p $(DEPENDENCY_BUILD_DIRECTORY_SDL) && \
	cd $(DEPENDENCY_BUILD_DIRECTORY_SDL) && \
	PKG_CONFIG_PATH=$(DEPENDENCY_OUTPUT_DIRECTORY)/lib/pkgconfig \
	$(DEPENDENCY_SOURCE_DIRECTORY_SDL)/configure \
		CFLAGS="-O2" \
...
$(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libmpv.a: $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libSDL2.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libiconv.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libz.a $(FFMPEG_LIBS) $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libass.a | $(DEPENDENCY_SOURCE_DIRECTORY_MPV) $(DEPENDENCY_OUTPUT_DIRECTORY)
	...
	NM=$(NM) \
	RANLIB=$(RANLIB) \
	CFLAGS="-I$(DEPENDENCY_OUTPUT_DIRECTORY)/include -I$(DEPENDENCY_OUTPUT_DIRECTORY)/include/SDL2" \
