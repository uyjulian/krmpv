...
EXTLIBS += $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libspirv-cross-c-shared.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libshaderc.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libshaderc.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libSDL2.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libiconv.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libz.a $(FFMPEG_LIBS) $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libass.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libfribidi.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libharfbuzz.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libfreetype.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libbrotlidec.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libbrotlicommon.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libmpv.a
SOURCES += $(EXTLIBS)
OBJECTS += $(EXTLIBS)
...
$(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libspirv-cross-c-shared.a: | $(DEPENDENCY_SOURCE_DIRECTORY_SPIRV_CROSS) $(DEPENDENCY_OUTPUT_DIRECTORY)
	mkdir -p $(DEPENDENCY_BUILD_DIRECTORY_SPIRV_CROSS) && \
	cd $(DEPENDENCY_BUILD_DIRECTORY_SPIRV_CROSS) && \
	...
	cmake \
		...
		$(DEPENDENCY_SOURCE_DIRECTORY_SPIRV_CROSS) && \
	$(MAKE) && \
	$(MAKE) install && \
...
$(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libshaderc.a: | $(DEPENDENCY_SOURCE_DIRECTORY_SHADERC) $(DEPENDENCY_SOURCE_DIRECTORY_SPIRV_TOOLS) $(DEPENDENCY_SOURCE_DIRECTORY_SPIRV_HEADERS) $(DEPENDENCY_SOURCE_DIRECTORY_GLSLANG) $(DEPENDENCY_OUTPUT_DIRECTORY)
	mkdir -p $(DEPENDENCY_BUILD_DIRECTORY_SHADERC) && \
	cd $(DEPENDENCY_BUILD_DIRECTORY_SHADERC) && \
	PKG_CONFIG_PATH=$(DEPENDENCY_OUTPUT_DIRECTORY)/lib/pkgconfig \
	cmake \
		-G"Unix Makefiles" \
		-DCMAKE_SYSTEM_NAME=Windows \
		...
		$(DEPENDENCY_SOURCE_DIRECTORY_SHADERC) && \
	$(MAKE) && \
	$(MAKE) install
...
$(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libmpv.a: $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libspirv-cross-c-shared.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libshaderc.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libSDL2.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libiconv.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libz.a $(FFMPEG_LIBS) $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libass.a | $(DEPENDENCY_SOURCE_DIRECTORY_MPV) $(DEPENDENCY_OUTPUT_DIRECTORY)
	...
	NM=$(NM) \
	RANLIB=$(RANLIB) \
	CFLAGS="-I$(DEPENDENCY_OUTPUT_DIRECTORY)/include -I$(DEPENDENCY_OUTPUT_DIRECTORY)/include/SDL2 -I$(DEPENDENCY_OUTPUT_DIRECTORY)/include/spirv_cross" \
